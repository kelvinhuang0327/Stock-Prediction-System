...
import { PolicyAuditTrailService } from '@/lib/jobs/PolicyAuditTrailService';
...
export async function GET(request: Request) {
  try {
    ...
    console.error('Failed to build autonomous alert policy audit trail:', error);
    return NextResponse.json(
      {
        error: 'Failed to build autonomous alert policy audit trail',
