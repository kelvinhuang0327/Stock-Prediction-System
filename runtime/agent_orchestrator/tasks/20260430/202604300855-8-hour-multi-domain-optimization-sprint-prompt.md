...
**Problem 1 — system_health.** Most recent StockQuote was 280h ago. Market data sync may be broken or incomplete, silently degrading all downstream signal quality.

Evidence: `Latest StockQuote: 2026-04-18T16:28:29.000Z`; `Threshold: must be within 2 trading days`; `Affected stock: 2014`

**Problem 2 — test_coverage.** 24 orchestrator modules have no test file: aiModulesService, aiService, llmExecutionPolicy, schedulerGuard, types. Critical planner/worker/gate logic runs without regression protection.
...
- [ ] [system] Test files created for: aiModulesService, aiService, llmExecutionPolicy, schedulerGuard
...
**Problem 2 — wiki_docs.** 5 markdown files in docs/ or wiki/ have not been updated in > 30 days. They may reference outdated APIs, file paths, or procedures.

Evidence: `docs/DATA_SYNC_GUIDE.md`; `docs/KELLY_RISK_INTEGRATION.md`; `docs/autonomous-quickstart.md`
...
- [ ] [feature] Each stale file reviewed and updated or marked as archived
- [ ] [feature] File paths and API references verified against current codebase
- [ ] [feature] CHANGELOG.md updated with a doc-refresh entry
- [ ] [feature] No dead links remaining in docs/ or wiki/
