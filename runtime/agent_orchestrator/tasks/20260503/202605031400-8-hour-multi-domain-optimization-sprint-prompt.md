...
**Problem 1 — system_health.** Most recent StockQuote was 358h ago. Market data sync may be broken or incomplete, silently degrading all downstream signal quality.

Evidence: `Latest StockQuote: 2026-04-18T16:28:29.000Z`; `Threshold: must be within 2 trading days`; `Affected stock: 2014`

**Problem 2 — test_coverage.** 37 orchestrator modules have no test file: adaptivePolicy.test, aiModulesService.test, aiService.test, llmUsageWarnings, schedulerGuard.test. Critical planner/worker/gate logic runs without regression protection.
...
Evidence: `Missing loading/error in src/app/calendar`; `Missing loading/error in src/app/asset-doubling`; `Missing loading/error in src/app/candidates`

**Problem 2 — wiki_docs.** USER_GUIDE.md was last modified 107 days ago. Recent orchestrator, CTO review, and daemon autostart changes are undocumented.

Evidence: `USER_GUIDE.md mtime: 2026-01-16T08:20:18.352Z`; `Age: 107 days since last update`
